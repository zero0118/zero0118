		...
		<nav class="navbar navbar-default navbar-static-top"
			...
			<div id="menutab" class="navbar-top-links">
				<ul class="nav nav-tabs">
					<!-- <li class="home"><a href="#1" data-toggle="tab">HOME</a></li> -->
					<!-- active 옵션 -->
					<li class="home"><a href="#1" data-toggle="tab"><i
							class="fa fa-edit fa-fw"></i>home</a></li>
					<li class="authorization"><a href="#2" data-toggle="tab"><i
							class="fa fa-edit fa-fw"></i>전자결재</a></li>
					<li class="schedule"><a href="#3" data-toggle="tab"><i
							class="fa fa-calendar fa-fw"></i>일정관리</a></li>
					<li class="attendance"><a href="#4" data-toggle="tab"><i
							class="fa fa-clock-o"></i>근태관리</a></li>
					<li class="board"><a href="#5" data-toggle="tab"><i
			...
			<div class="sidebar">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li class="home"><a href="#">게시판<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<li><a href="#">메인사이드</a></li>
								<li><a href="#">메인사이드2</a></li>
