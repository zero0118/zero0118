   ...
   <div class="table">
      <table class="table table-bordered">
         ...
         <tr>
            ...
            <td colspan="3">
               <input type="text">
               <input type="button" value="수신부서지정">   
            </td>
         </tr>
         <tr>
            <th>기안자</th>
         ...
         <button>참조자 지정</button>
         </td>
         </tr>
         <tr>
            <th>제목</th>
            <td colspan="5">
               <input type="text" name="doc_title" style="width:700px">
            </td>
         </tr>
         <tr>
	         <th>기간</th>
		     <td> 
		         <input type="text" id="testDatepicker" value ="시작일"> &nbsp;~&nbsp;  
         ...
         <tr>
            <td colspan="6" align="center">
              	상기와 같은 사유로 인하여 결근(병가)계를 제출하오니 재가바랍니다.
            </td>   
         </tr>
         <tr>
            <td colspan="6" align="center">
